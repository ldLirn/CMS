...
<div id="page-wrapper">
    ...
    <div class="col-md-12 graphs">
        <div class="xs">
            ...
            <div>
                <ol class="breadcrumb">
                    <li><a role="button" class="btn btn-default" href="<?php echo U('Article/cate_add',array('nav_id'=>$_GET['nav_id']));?>">添加分类</a></li>
                </ol>
            </div>
            <div class="bs-example4" data-example-id="contextual-table">
                <table class="table">
                    ...
                    <tbody>
                    <form method="post" action="<?php echo U('Article/sort');?>" id="defaultForm">
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="active">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="sort[]" value="<?php echo ($v["sort"]); ?>" class="form-control1 input-sm" id="smallinput" style="width: 40px;height: 25px;"></td>

                                <td>
                                    <a class="btn btn-xs btn-info" href="<?php echo U('Article/cate_edit/',array('id'=>$v['id'],'nav_id'=>$_GET['nav_id']));?>" role="button">修改</a>
                            ...
                            <?php if(is_array($v["child"])): $i = 0; $__LIST__ = $v["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($i % 2 );++$i;?><tr class="active">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="sort[]" value="<?php echo ($child["sort"]); ?>" class="form-control1 input-sm" id="" style="width: 40px;height: 25px;">
                                    </td>
                                    <td>
                                        <a class="btn btn-xs btn-info" href="<?php echo U('Article/cate_edit/',array('id'=>$child['id'],'nav_id'=>$_GET['nav_id']));?>" role="button">修改</a>
                                        <button type="button" class="btn btn-xs btn-warning warning_44">删除</button>
                                    </td>

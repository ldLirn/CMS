    ...
    <div class="xs">
        ...
        <div style="background: #f5f5f5;width: 100%;height: 50px">
            <ol class="breadcrumb" style="float: left;width: 20%">
                <a class="btn btn-default" href="<?php echo U('Config/add',array('nav_id'=>$_GET['nav_id']));?>" role="button">添加配置</a>
            </ol>
        ...
        <div class="bs-example4" data-example-id="contextual-table">
            <table class="table">
                ...
                <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="active">
                    ...
                    <td><?php echo ($v["data_type_name"]); ?></td>
                    <td>
                        <a class="btn btn-xs btn-info dialog" href="<?php echo U('Config/edit',array('id'=>$v['id'],'nav_id'=>$_GET['nav_id']));?>"  role="button">修改</a>

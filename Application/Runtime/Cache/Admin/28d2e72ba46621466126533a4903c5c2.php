    ...
    <div class="xs">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="<?php echo U('Menu/create');?>" id="defaultForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8"><select name="pid" id="selector1" class="form-control1">
                            ...
                            <?php if(is_array($menuListData)): $i = 0; $__LIST__ = $menuListData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["navname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
